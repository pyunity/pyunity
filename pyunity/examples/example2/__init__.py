...
def main():
    scene = SceneManager.AddScene("Scene2")
    ...
    collider.min = Vector3(-1, -1, -1)
    collider.max = Vector3(1, 1, 1)
    collider.pos = Vector3(0, 0, 0)
    ...
    collider = cube.AddComponent(AABBoxCollider)
    collider.min = Vector3(3, -1, -1)
    collider.max = Vector3(5, 1, 1)
    collider.pos = Vector3(4, 0, 0)
