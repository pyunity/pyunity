...
class GameObject(SavesProjectID):
    ...
    def RemoveComponent(self, componentClass: Type[CT]) -> None: ...
...
class HideInInspector(Generic[T]):
    ...
    name: Union[str, None]
    def __init__(self, type_: Union[Type[T], str], default: Union[T, None] = ...) -> None: ...
    def __set_name__(self, owner: Component, name: str) -> None: ...

class ShowInInspector(HideInInspector[T]):
    name: Union[str, None]
    def __init__(self, type: Union[Type[T], str], default: Union[T, None] = ..., name: Union[str, None] = ...) -> None: ...
    def __set_name__(self, owner: Component, name: str) -> None: ...
...
class Transform(SingleComponent):
    localPosition: Union[Vector3, None] = ...
    localRotation: Union[Quaternion, None] = ...
    localScale: Union[Vector3, None] = ...
