...
class Transform(SingleComponent):
    ...
    def Translate(self, translation: Vector3, relativeTo: Union[Space, Transform] = ...) -> None: ...
    def Rotate(self, rotation: Union[Vector3, Quaternion], relativeTo: Space = ...) -> None: ...
    def ReparentTo(self, parent: Transform, relativeTo: Space = ...) -> None: ...
    def List(self) -> None: ...
