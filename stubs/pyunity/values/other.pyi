...
from typing import Optional, Any, Dict, Callable, TypeVar, Type, Tuple, Generic, Union
...
class SavableStruct:
    ...
    def fromDict(self, factory, attrs, instanceCheck: Optional[Callable[..., Tuple[Type[T], T]]]) -> object: ...
