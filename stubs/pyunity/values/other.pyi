...
class SavableStruct(Generic[TWRAP]):
    ...
    def fromDict(self, factory: Callable[..., TWRAP], attrs: Mapping[str, Any], instanceCheck: Optional[Callable[[Type[T], T], Tuple[Type[T], T]]] = ...) -> TWRAP: ...
    def factoryWrapper(self, factory: Callable[..., TWRAP]) -> Callable[..., TWRAP]: ...
    def __call__(self, cls: Type[TWRAP]) -> Type[TWRAP]: ...
