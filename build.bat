...
py prepare.py
py -3.6 setup.py build -c mingw32 bdist_wheel -d dist\0.5.0\
py -3.7 setup.py build -c mingw32 bdist_wheel -d dist\0.5.0\
py -3.8 setup.py build -c mingw32 bdist_wheel -d dist\0.5.0\
py setup.py build -c mingw32 bdist_wheel -d dist\0.5.0\ sdist -d dist\0.5.0\
RMDIR /S /Q docs\en\
