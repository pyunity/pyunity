...
if len(sys.argv) < 2:
    ...
    desc_new = [
        ...
        "".join([
            ...
            "0.3.0.svg)](https://github.com/rayzchen/pyunity/compare/0.2.1...master)",
            "[![Language grade: Python](https://img.shields.io/lgtm/grade/python/g/rayzchen/pyunity.svg",
            "?logo=python&logoColor=FBE072)](https://lgtm.com/projects/g/rayzchen/pyunity/context:python)",
